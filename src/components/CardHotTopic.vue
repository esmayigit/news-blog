<template>
  ...
  >
    ...
    />
    <div
      class="absolute w-60 sm:w-11/12 md:w-full h-20 md:h-40 top-28 sm:top-52 md:top-40 flex flex-col md:px-6 space-y-4"
    >
      <h1
      ...
      <div class="flex space-x-4">
        ...
        <p class="text-slate-100 text-[8px] sm:text-xs">CNN Source</p>
      </div>
    </div>
  </div>
</template>
